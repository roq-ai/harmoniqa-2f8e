...
import { getCommunityDiscussionById } from 'apiSdk/community-discussions';
...
function CommunityDiscussionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Community Discussion Detail View
          </Text>
          {hasAccess('community_discussion', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/community-discussions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
