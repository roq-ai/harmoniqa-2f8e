...
function EducationalResourceListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('educational_resource', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/educational-resources/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('educational_resource', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/educational-resources/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('educational_resource', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/educational-resources/edit/${record.id}`} passHref legacyBehavior>
                          <Button
